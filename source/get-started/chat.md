...
First let’s create a `package.json` manifest file that describes our project with `npm init` . I recommend you place it in a dedicated empty directory (I’ll call mine `chat-example`).
